...
const DARK = {
  bg: '#0a0e1a', card: '#1a2035', surface: '#111827',
  primary: '#6366f1', secondary: '#818cf8', accent: '#22c55e',
  text: '#f1f5f9', textSec: '#94a3b8', textMuted: '#64748b',
  border: '#2a3352', danger: '#ef4444', warning: '#f59e0b',
};
const LIGHT = {
...
function MainTabs() {
  ...
  return (
    ...
    >
      <Tab.Screen name="Home" component={HomeScreen} options={{ title: 'NavX' }} />
    ...
    <ThemeContext.Provider value={{ colors, isDark, setIsDark, language, setLanguage }}>
      ...
      >
        ...
        <Stack.Navigator screenOptions={{ headerShown: false }}>
          ...
          <Stack.Screen name="AR" component={ARScreen} options={{ animation: 'slide_from_bottom' }} />
