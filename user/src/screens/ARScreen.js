...
export default function ARScreen({ navigation, route }) {
  ...
  if (currentDir) {
    if (currentDir.instruction.includes("left")) {
      arrowDirection = "left";
      arrowIcon = "arrow-back";
    } else if (currentDir.instruction.includes("right")) {
      arrowDirection = "right";
      arrowIcon = "arrow-forward";
    } else if (currentDir.instruction.includes("stairs")) {
      arrowDirection = "stairs";
      arrowIcon = "trending-up";
    } else if (currentDir.instruction.includes("elevator")) {
      arrowDirection = "elevator";
      arrowIcon = "arrow-up";
    }
  }
      ...
      <View style={StyleSheet.absoluteFill}>
        ...
        <Svg width={SW} height={SH} style={StyleSheet.absoluteFill}>
          ...
          <Line
            x1={SW / 2}
            y1={SH * 0.65}
            x2={SW / 2 + Math.sin((relativeAngle * Math.PI) / 180) * 100}
            y2={SH * 0.65 - 80}
            stroke="#6366f1"
            strokeWidth={4}
            strokeLinecap="round"
          ...
          />
          <Circle
            cx={SW / 2 + Math.sin((relativeAngle * Math.PI) / 180) * 100}
            cy={SH * 0.65 - 80}
            r={8}
            fill="#6366f1"
            opacity={0.8}
        ...
        {/* Bottom info */}
        <View
          style={[styles.bottomBar, { backgroundColor: colors.card + "F0" }]}
        >
          <View style={styles.infoRow}>
            ...
            <View style={styles.infoItem}>
              ...
              <Text style={styles.infoValue}>
                {Math.round(remainingDist / 1.2)}s
              </Text>
            ...
            <View style={styles.infoItem}>
              ...
              <Text style={styles.infoValue}>
                {currentStep + 1}/{routeData?.directions?.length || 0}
              </Text>
