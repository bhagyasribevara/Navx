...
// Analytics
export const getAnalyticsSummary = (campusId) => api.get(`/analytics/summary/${campusId}`);
export const getHeatmap = (campusId, floorId) => api.get(`/analytics/heatmap/${campusId}?floorId=${floorId}`);
